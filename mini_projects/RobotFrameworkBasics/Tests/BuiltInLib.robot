...
Test Set and Get Local Variable
    Set Local Variable  ${GREETING}  Hello, ${USER}        #Makes a variable available everywhere within the local scope.
...
Test Set Log Level and Reset
    ...
    Reset Log Level        #Resets the log level to the original value.
