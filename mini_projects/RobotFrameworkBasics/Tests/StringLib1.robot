...
Test for Should Be Lower Case keyword
   Should Be Lower Case    test
   Should Be Lower Case    hello#123     #special characters have no effect
   #fails if Robot, roBot or roboT -- upper case present anywhere in string

Test for Should Be Upper Case keyword
   Should Be Upper Case    TEST
   Should Be Upper Case    TEST#1     #special characters have no effect
   #fails if rOBOT, RObOT or ROBOt -- lower case present anywhere in string

Test for Should Be Title Case keyword
   Should Be Title Case    TEST
   Should Be Title Case    Test Title    #all words should be title case-- fails for Test title
   Should Be Title Case    Test#1     #special characters have no effect
