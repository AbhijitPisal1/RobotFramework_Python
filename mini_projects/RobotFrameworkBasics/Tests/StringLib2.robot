...
Test for Convert Case keywords
    ${str1}=    Convert To Lower Case    ABC    #abc
    ${str2}=    Convert To Lower Case    1A2C30HJI    #1a2c30hji
    
    ${str3}=    Convert To Upper Case    xyz    #XYZ
    ${str4}=    Convert To Upper Case    12sa5uid    #12SA5UID
